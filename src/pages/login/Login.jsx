...
const Login = () => {
  ...
  return (
    <div className="bg-blue-50 dark:bg-gray-900">
      ...
      {loading && (
         <div role="status" className="absolute -translate-x-1/2 -translate-y-1/2 top-2/4 left-1/2 backdrop-blur-xl bg-white/30 h-full w-full flex items-center justify-center">
